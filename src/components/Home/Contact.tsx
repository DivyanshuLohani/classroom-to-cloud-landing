            ...
            <div>
              ...
              <div className="mt-4 md:mb-12 max-w-2xl">
                ...
                <p className="text-xl text-muted-foreground">
                  Get online and experience unlimited possibilites
                </p>
              </div>
              {/* End Title */}
              {/* Blockquote */}
              <blockquote className="hidden md:block relative max-w-sm">
                ...
                <div className="relative z-10">
                  <p className="text-xl italic">
                    E-learning opens doors to education that were previously
                    closed, bridging gaps across continents and cultures.
                  </p>
                </div>
              </blockquote>
              {/* End Blockquote */}
